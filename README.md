...
* Docker
        ...
        docker run -it -v /italo/chain:/root/.bititalo -v /italo/wallet:/wallet -p 18080:18080 italo

        # or in background
        docker run -it -d -v /italo/chain:/root/.bititalo -v /italo/wallet:/wallet -p 18080:18080 italo
