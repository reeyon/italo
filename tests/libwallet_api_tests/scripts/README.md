...
* Running italo node, linked to private/public testnet. 
  ...
  [Manual](https://github.com/italoexamples/private-testnet) explaining how to run private testnet.
...
* Directory with pre-generated wallets
  ...
  By default, tests expect these wallets to be in ```/var/italo/testnet_pvt```. 
